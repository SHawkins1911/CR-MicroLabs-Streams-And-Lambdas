...
public final class PersonWarehouse implements Iterable<Person> {
    ...
    public Stream<Person> getUniquelyNamedPeople() {
        ...
        return people.stream().collect(Collectors.toMap(Person::getName, Function.identity(),
                (v1, v2) -> v1, LinkedHashMap::new)).values().stream();
    }
    ...
    public Stream<Person> getUniquelyNamedPeopleStartingWith(Character character) {
        ...
        return people.stream().filter((s) -> character.equals(s.getName().charAt(0))).collect(Collectors.toMap(Person::getName, Function.identity(),
                (v1, v2) -> v1, LinkedHashMap::new)).values().stream();
    }
    ...
    public Stream<Person> getFirstNUniquelyNamedPeople(int n) {
        ...
        return people.stream().collect(Collectors.toMap(Person::getName, Function.identity(),
                (v1, v2) -> v1, LinkedHashMap::new)).values().stream().limit(n);
    }
